				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="fakultas" class="form-control" required>
							<option value="<?php echo $row['fakultas']; ?>"> - Daftar Jurusan - </option>
