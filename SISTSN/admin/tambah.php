		...
		<div class="content">
			...
			if(isset($_POST['add'])){ 
				...
				if(mysqli_num_rows($cek) == 0){ 
					if($pass1 == $pass2){ 
						$pass = md5($pass1); 
						$insert = mysqli_query($koneksi, "INSERT INTO tbl_mahasiswa(nim, nama, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat_asal, alamat_sekarang, no_telepon, email, agama, fakultas, username, level, password) VALUES('$nim','$nama', '$jenis_kelamin', '$tempat_lahir', '$tanggal_lahir', '$alamat_asal', '$alamat_sekarang', '$no_telepon', '$email', '$agama', '$fakultas', '$username', '$level', '$pass')") or die(mysqli_error($koneksi)); 
						if($insert){ 
