				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="fakultas" class="form-control" required>
							<option value="<?php echo $row['fakultas']; ?>"> - Pilih Jurusan - </option>
							<option value="RPLK">RPLK</option>
							<option value="RSK">RSK</option>
							<option value="RPKK">RPKK</option>
							<option value="RKS">RKS</option>
						</select>
					</div>
                    <div class="col-sm-3">
                    <b>Jurusan Sekarang :</b> <span class="label label-success"><?php echo $row['fakultas']; ?></span>
				    </div>
				</div>
				<div class="form-group">
